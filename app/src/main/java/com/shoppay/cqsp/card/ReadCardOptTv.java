 ...
 * 联系方式QQ：398320879
 */
public class ReadCardOptTv extends Activity {
    ...
    private TextView textView;  //接受需要显示卡号的控件
    private HardwareOpt mHardwareOpt; //sunmiP1n 硬件接口操作模块

    public ReadCardOptTv() {
     ...
     */
    public ReadCardOptTv(TextView textView) {
