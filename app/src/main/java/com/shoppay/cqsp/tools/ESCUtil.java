package com.shoppay.cqsp.tools;
...
public class ESCUtil
{
    ...
    public static byte[] generateMockData()
    {
        try
        {
            ...
            byte[] ordernum = "消费单号:".getBytes("gb2312");
            byte[] vipcardnum = "会员卡号:".getBytes("gb2312");
            byte[] vipname = "会员名称:".getBytes("gb2312");
            byte[] xiahuaxian = "----------------------:".getBytes("gb2312");
            byte[] xiaofeinum = "消费金额:".getBytes("gb2312");
            byte[] youhuinum = "优惠金额:".getBytes("gb2312");
            byte[] getjifen = "获得积分:".getBytes("gb2312");
            byte[] shoulepay = "应付金额:".getBytes("gb2312");
            byte[] factpay = "实付金额:".getBytes("gb2312");
            byte[] zhaoqian = "找零金额:".getBytes("gb2312");
            byte[] user = "操作人员:".getBytes("gb2312");
            byte[] ordertime = "消费时间:".getBytes("gb2312");
            ...
            byte[][] mticket = {boldOn, title, boldOff, nextLine, tickname, nextLine, ordernum, nextLine, vipcardnum, nextLine,
                    vipname, next2Line, xiahuaxian, nextLine, xiaofeinum, nextLine, youhuinum, nextLine, getjifen,
                    next2Line, xiahuaxian, nextLine, shoulepay, next2Line, factpay, nextLine, zhaoqian, nextLine,
                    user, nextLine, customs, next2Line};
    ...
    public static byte[] kuaisuData()
    {
        try
        {
            ...
            byte[] breakPartial = ESCUtil.feedPaperCutPartial();
            byte[][] mticket = {boldOn, title, boldOff, nextLine, left, tickname, nextLine, left, ordernum, nextLine, left, vipcardnum, nextLine,
                    left, vipname, next2Line, xiahuaxian, nextLine, left, xiaofeinum, nextLine, left, youhuinum, nextLine, left, getjifen,
                    next2Line, xiahuaxian, nextLine, left, shoulepay, next2Line, left, factpay, nextLine, left, zhaoqian, nextLine,
                    left, user, nextLine, left, ordertime, nextLine, left, customs, next4Line, breakPartial};
    ...
    public static byte[] jiciData()
    {
        try
        {
            ...
            byte[] breakPartial = ESCUtil.feedPaperCutPartial();
            byte[][] mticket = {boldOn, title, boldOff, nextLine, left, tickname, nextLine, left, ordernum, nextLine, left, vipcardnum, nextLine,
                    left, vipname, next2Line, xiahuaxian, nextLine, left, sername, nextLine, left, serprice, nextLine, left, sernum, nextLine,
                    left, sertotlenum,
                    next2Line, xiahuaxian, nextLine, left, shoulepay, next2Line, left, factpay, nextLine, left, zhaoqian, nextLine,
                    left, user, nextLine, left, ordertime, nextLine, left, customs, next4Line, breakPartial};
